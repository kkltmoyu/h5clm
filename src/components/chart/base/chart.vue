<template>
    <div :style="{height:height?height+'px':'',lineHeight:height?height+'px':'',width:width?width:''}">
        <div v-show="options.series&&options.series.length&&noDataText===''" :id="defaults.id" class="chart-item" style="height:100%;">
        </div>
