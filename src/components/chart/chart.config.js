...
const LINECOLOR = 'rgba(23,35,61,0.75)';
const config = {
    rich: {
        white: {
            color: '#FFFFFF',
    ...
    getBarBaseConfig: () => {
        return {
            ...
            tooltip: {
                ...
                padding: [5, 5],
                extraCssText: 'box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 3px 1px -2px rgba(0,0,0,0.12), 0 1px 5px 0 rgba(0,0,0,0.20);'
            },
            legend: {
                show: false,
                type: 'scroll',
                ...
                regions: [{
                    ...
                    itemStyle: {
                        normal: {
                            opacity: 1,
                            areaColor: 'rgba(23,35,61,0.06)',
                            borderColor: 'rgba(23,35,61,0.06)'
                        },
                        emphasis: {
                            areaColor: 'rgba(23,35,61,0.06)'
                        }
