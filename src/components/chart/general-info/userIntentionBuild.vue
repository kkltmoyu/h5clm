...
<template>
    <div class="user_intention_build">
        <i-chart :options="poiChart.options" :height="height" :width='width' ref="poiChart" :noDataText="poiChart.noDataText"></i-chart>
    </div>
</template>
<script>
import {
